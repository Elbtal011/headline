...
app.locals.magicvicsChatUrl = process.env.MAGICVICS_CHAT_URL || 'https://portal.headlinegp.com/support';
app.locals.magicvicsApiBase = process.env.MAGICVICS_API_BASE || 'https://portal.headlinegp.com';
